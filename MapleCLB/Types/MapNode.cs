...
namespace MapleCLB.Types {
    public class MapNode {
        public int Id { get; }
        public ReadOnlyDictionary<int, Tuple<short[], string>> Portals;
        public ReadOnlyDictionary<int, int> Choice { get; set; }

        public MapNode(int id, ReadOnlyDictionary<int, Tuple<short[], string>> portals, ReadOnlyDictionary<int, int> choice) {
            Id = id;
            Portals = portals;
            Choice = choice;
        }
